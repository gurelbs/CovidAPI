...
chartWrap.addEventListener('click', changeChartLook)
    // mobile event
btnWrap.addEventListener('ontouchstart', handleClickByRegion)
countries.addEventListener('ontouchstart', handleCountriesData)
statusBtnWrap.addEventListener('ontouchstart', handleData)
chartWrap.addEventListener('ontouchstart', changeChartLook)