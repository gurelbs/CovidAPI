...
chartWrap.addEventListener('click', changeChartLook)
    // mobile event
btnWrap.addEventListener('touchend', handleClickByRegion)
countries.addEventListener('touchend', handleCountriesData)
statusBtnWrap.addEventListener('touchend', handleData)
chartWrap.addEventListener('touchend', changeChartLook)